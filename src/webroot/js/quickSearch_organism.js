$(document).ready(function(){
    ...
    $("#search_organism").data("ui-autocomplete")._renderItem = function (ul, item) {
        var li = $("<li>")
                .append("<a href='"+WebRoot+"/organism/details/byId/"+item.organism_id+"'><span style='display:inline-block; width: 100%; font-style: italic;'>" + item.scientific_name + "</span><span style='color: #338C8C'>" + item.rank + "</span></a>")
                .appendTo(ul);
        return li;
    };
