...
EOF;
        $stm_get_parent_phylonode_id = $db->prepare($query_get_parent_phylonode_id);
...
EOF;
        $stm_get_parent_organism_id = $db->prepare($query_get_parent_organism_id);
...
EOF;
        $stm_get_organism_name = $db->prepare($query_get_organism_name);
