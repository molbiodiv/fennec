...
# import trait table
$FENNEC_PATH/bin/console app:import-trait-entries --user-id $WEBUSER_ID --default-citation "IUCN ${YEAR}. IUCN Red List of Threatened Species. Version $VERSION <www.iucnredlist.org>" --traittype "IUCN Red List" --mapping scientific_name --skip-unmapped iucn_import.tsv
